...
class SimpleBinaryTreeCases(unittest.TestCase):
    ...
    def test_SimpleBinaryTreeBalance1(self):
        bt = SimpleBinaryTree()
        bt.insert(12)
        bt.insert(8)
        bt.insert(20)
    ...
    def test_SimpleBinaryTreeBalance2(self):
        bt = SimpleBinaryTree()
        bt.insert(12)
        bt.insert(8)
        bt.insert(4)
        ...
        bt.insert(21)
        bt.insert(20)
        self.assertTrue(bt.isBalanced() is True)
    ...
    def test_RB1(self):
        ...
        self.assertIs(
            ...
            "The root node should be 29-black",
        )
        self.assertIs(
            rbt.root.R.S == 34,
            rbt.root.R.color == "black",
            "The 1st right node should be 34-black",
        )
        self.assertIs(
            rbt.root.R.R.S == 45,
            rbt.root.R.R.color == "red",
            "The second right node should be 45-red",
        )
        self.assertIs(
            rbt.root.R.R.R.S == 49,
            rbt.root.R.R.R.color == "black",
            "The 3rd right node should be 49-black",
        )
        self.assertIs(
            rbt.root.R.R.R.L.S == 48,
            rbt.root.R.R.R.L.color == "red",
            "The tested leaf should be 48-red",
        )
